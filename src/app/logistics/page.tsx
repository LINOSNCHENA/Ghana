      ...
      <main className="max-w-6xl mx-auto px-4 py-12">
        ...
        <div className="mt-12 text-center">
          <p className="text-lg text-gray-800 mb-4">
            Whether you are importing machinery from China, exporting goods across ECOWAS, or transporting educational materials into Africa&apos;s rural regions — Sir Louis & Gao
            delivers.
          </p>
