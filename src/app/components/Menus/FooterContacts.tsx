...
import { COMP_LOGO_BIG, COMP_ADDRESS, COMP_COPYRIGHT, COMP_FB, COMP_LINKEDIN, COMP_WHATSAPP, COMP_MOTTO, COMP_TIKTOK, WEB_MASTER } from "@/app/utils/constants";
