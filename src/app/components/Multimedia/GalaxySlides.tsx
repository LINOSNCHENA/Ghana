...
export function CompanySlides() {
  ...
  return (
    <section className="relative w-full py-10 overflow-hidden bg-gray-50">
      {/* Title */}
      <h2 className="text-3xl font-bold text-center mb-10 text-gray-800">Company Foto Galary</h2>
      ...
      {/* Slider */}
      <div ref={scrollRef} className="flex justify-center overflow-x-auto scroll-smooth gap-8 px-6 scrollbar-hide snap-x snap-mandatory">
        {fotoData.map((item) => (
